...
const Contact = () => {
  ...
  return (
    <section className="bg-slate-950" id="contact">
      <div className=" dark:bg-slate-950 mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        {header && <HeaderWidget header={header} titleClassname="text-3xl sm:text-5xl" />}
        <div className="flex items-stretch justify-center">
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              {content && <p className="mt-3 mb-12 text-lg text-gray-300 dark:text-slate-400">{content}</p>}
